                        ...
                        <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-[2rem] border border-gray-100 dark:border-gray-800">
                            <div class="p-8 text-gray-900 dark:text-gray-100">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="mt-2 block w-full bg-gray-50 dark:bg-gray-800 border-none focus:ring-2 focus:ring-emerald-500 rounded-2xl" :value="old('name')" placeholder="e.g. Amoxicillin 500mg" required />
                                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                </div>
                                
                                <div class="mt-6">
                                    <x-input-label for="description" :value="__('Product Description')" class="text-gray-600 dark:text-gray-400 font-bold" />
                                    <textarea id="description" name="description" class="w-full mt-2 rounded-2xl bg-gray-50 dark:bg-gray-800 border-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100 h-40" placeholder="Describe usage, dosage..." required>{{ old('description') }}</textarea>
                            ...
                            <div class="p-8 text-gray-900 dark:text-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-text-input id="price" name="price" type="number" step="0.01" class="mt-2 block w-full bg-gray-50 dark:bg-gray-800 border-none focus:ring-2 focus:ring-emerald-500 rounded-2xl" :value="old('price')" required />
                                        <x-input-error :messages="$errors->get('price')" class="mt-2" />
                                    </div>
                                    
                                    <div>
                                        <x-input-label for="stock" :value="__('Available Stock')" class="text-gray-600 dark:text-gray-400 font-bold" />
                                        <x-text-input id="stock" name="stock" type="number" class="mt-2 block w-full bg-gray-50 dark:bg-gray-800 border-none focus:ring-2 focus:ring-emerald-500 rounded-2xl" :value="old('stock')" required />
                            ...
                            <div class="p-8 text-gray-900 dark:text-gray-100">
                                ...
                                <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800">
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        ...
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-300 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:bg-emerald-500 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                        ...
                        <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-[2rem] border border-gray-100 dark:border-gray-800">
                            <div class="p-8 text-gray-900 dark:text-gray-100">
                                ...
                                <div class="relative group mb-4">
                                    ...
                                    <img id="imagePreview" src="https://placehold.co/600x400/111827/cbd5e1?text=No+Image+Selected" class="relative w-full h-48 object-cover rounded-2xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700"/>
                                </div>
